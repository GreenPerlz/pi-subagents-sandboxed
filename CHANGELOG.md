...
### Fixed
- Exited cleanup-unproven orchestrator runs now leave the active widget after terminal retention while keeping failed/incomplete recovery evidence available in durable status and completed-run views.
