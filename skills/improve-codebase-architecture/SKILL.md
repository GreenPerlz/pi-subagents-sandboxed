...
subagent({
  ...
  task: "Explore the codebase for architectural deepening opportunities. Read CONTEXT.md/CONTEXT-MAP.md and relevant ADRs first. Return friction points with evidence, candidate modules/seams, and likely validation impact. Do not modify project/source files."
})
```
