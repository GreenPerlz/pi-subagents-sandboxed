...
const DYNAMIC_STEP_KEYS = new Set(["expand", "parallel", "collect", "concurrency", "failFast", "worktree", "cwd", "phase", "label", "acceptance"]);
const RUNNER_DYNAMIC_STEP_KEYS = new Set([...DYNAMIC_STEP_KEYS, "effectiveAcceptance", "worktreeOptOutAuthorized"]);
...
const RUNNER_DYNAMIC_PARALLEL_KEYS = new Set([
	...
	"structuredOutput", "structuredOutputSchema", "tools", "extensions", "mcpDirectTools", "systemPrompt", "sandbox", "hostGitDiagnostic",
